...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            File destFile = new File(resultFile.getParentFile() + "/allFilesContent.txt");
    ...
    public static Map<String, byte[]> getFileTree(String root) throws IOException {
        ...
        Files.walkFileTree(Paths.get(root), options, 20, new InnerFileVisitor(result));
    ...
    private static class InnerFileVisitor extends SimpleFileVisitor<Path> {
        ...
        public InnerFileVisitor(Map<String, byte[]> result) {
            this.result = result;
        }
