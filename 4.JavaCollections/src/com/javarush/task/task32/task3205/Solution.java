...
public class Solution {
    ...
    public static SomeInterfaceWithMethods getProxy() {
        ...
        ClassLoader originalClassLoader = original.getClass().getClassLoader();
        ...
        return (SomeInterfaceWithMethods) Proxy.newProxyInstance(originalClassLoader,interfaces,customInvocationHandler);
    }
}
